...
defined in [PFDI]_ § 5 Compliance Requirements, and it must therefore implement
PFDI version 1.0. [#PFDINote]_
...
.. [#PFDINote] PFDI is an Arm standard interface that enables System Software to
   ...
   At the time of writing, only PFDI version 1.0 is defined. Future versions of
   this specification will manage compatibility.
