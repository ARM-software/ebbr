...
.. [ACPI] `Advanced Configuration and Power Interface specification v6.3
   <https://uefi.org/sites/default/files/resources/ACPI_6_3_final_Jan30.pdf>`_,
   January 2019, `UEFI Forum <http://www.uefi.org>`_
...
.. [UEFI] `Unified Extensable Firmware Interface Specification v2.8
   <https://uefi.org/sites/default/files/resources/UEFI_Spec_2_8_final.pdf>`_,
   January 2019, `UEFI Forum <http://www.uefi.org>`_
